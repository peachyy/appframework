...
public class MailTask implements ICallBack , Runnable {
	...
	public String send() throws EmailException{
		log.debug("send() called ,thread name: " + Thread.currentThread().getName());
	...
	public void execute(Object... objects) {
		...
		log.debug("execute called ,thread name: " +Thread.currentThread().getName() + " , result: " + result);
		Thread.interrupted();
	}
	...
	public void run() {
		...
		try{
			if(SEND_ASYNC.equals(sendType)){
				...
				result="Mail SendType is not " + SEND_ASYNC + " , Thread canceled. ";
